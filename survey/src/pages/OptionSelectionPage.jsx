const OptionSelectionPage = ({ selectedOption, setSelectedOption, onNavigate }) => {
    ...
    const wordspread = (
        <div>
            Module Selection<br />
            👉 Please read the following options carefully. You must select only ONE of the three
            options below. Your chosen option will define the exact structure and number of
            modules you select in this section of the survey.<br />
            Option 1: only 2 major modules<br />
            Option 2: only 3 modules (1 major module + 2 sub-modules)<br />
            Option 3: only 4 sub modules of your choice from any category<br />
            ⚠️ Important Note<br />
            Once you select an option (e.g., Option 2), you are committed to the exact format and
            number of modules specified by that option.<br />
            You cannot select Option 1 and then choose 4 sub-modules (the structure of
            Option 3).<br />
            You cannot select Option 3 and then choose 1 major module (the structure of
            Option 2).<br />
            Choose the option that best reflects the modules you wish to cover and review your
            choices carefully.
        </div>
    )
